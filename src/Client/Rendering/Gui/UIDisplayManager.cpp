...
void UIDisplayManager::Init(){
    ...
    s_BasicMesh.Create(2, VT_UNSIGNED_CHAR, FT_UNSIGNED_CHAR, &vertices, &indices, 8, 6);
    s_TexturedMesh.Create(2, VT_UNSIGNED_CHAR, FT_UNSIGNED_CHAR, VT_UNSIGNED_CHAR, &vertices, &indices, &textureCoords, 8, 6, 8);
